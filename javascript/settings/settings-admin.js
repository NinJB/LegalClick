const Password = Vue.createApp({
    ...
    methods: {
      async changePassword() {
        ...
        try {
          const response = await fetch(`http://localhost:5500/api/change-password-admin/${this.roleId}`, {
            method: 'POST',
            headers: {
      ...
      <div class="profile__container">
        <section class="profile__information">
          ...
          <div class="profile__options">
            <a :href="'/html/admins/profile.html?role_id=' + roleId"><button>Profile Information</button></a>
