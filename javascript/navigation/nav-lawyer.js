...
const app = Vue.createApp({
  ...
  methods: {
    ...
    async fetchNotifications() {
      ...
      const res = await fetch(`${baseUrl}/api/notifications/lawyer?user_id=${this.roleId}`);
      if (res.ok) {
    ...
    handleNotificationClick(notif) {
      if (notif.notification_purpose === 'request' || notif.notification_purpose === 'rejected' || notif.notification_purpose === 'approved' || notif.notification_purpose === 'accepted') {
        window.location.href = '/html/lawyer/consultation.html?role_id=' + this.roleId;
      } else if (notif.notification_purpose === 'application') {
        window.location.href = '/html/lawyer/secretary.html?role_id=' + this.roleId;
      } else if (notif.notification_purpose === 'reschedule') {
        window.location.href = '/html/lawyer/calendar.html?role_id=' + this.roleId;
  ...
  template: `
    <div class="layout">
        ...
        <div class="top-nav__right">
          ...
          <div class="profile-wrapper" 
            ...
            <div v-show="showProfileMenu" class="profile-menu">
              <a :href="'/html/lawyer/profile.html?role_id=' + roleId">Profile</a>
      ...
      <aside class="side-nav">
        <nav>
          <a :href="'/html/lawyer/search.html?role_id=' + roleId" class="chosen-dashboard" data-icon="search">
            <div class="icon-wrapper">
              <img src="/images/search-gray.png" class="icon-img" />
              <span class="icon-label">Search</span>
            </div>
          </a>
          <a :href="'/html/lawyer/messages.html?role_id=' + roleId" class="chosen-dashboard" data-icon="message">
            <div class="icon-wrapper">
              <img src="/images/message-gray.png" class="icon-img" />
              <span class="icon-label">Messages</span>
            </div>
          </a>
          <a :href="'/html/lawyer/consultation.html?role_id=' + roleId" class="chosen-dashboard" data-icon="consultation">
            <div class="icon-wrapper">
              <img src="/images/consultation-gray.png" class="icon-img" />
              <span class="icon-label">Consultations</span>
            </div>
          </a>
          <a :href="'/html/lawyer/calendar.html?role_id=' + roleId" class="chosen-dashboard" data-icon="calendar">
            <div class="icon-wrapper">
              <img src="/images/calendar-gray.png" class="icon-img" />
              <span class="icon-label">Calendar</span>
            </div>
          </a>
          <a :href="'/html/lawyer/secretary.html?role_id=' + roleId" class="chosen-dashboard" data-icon="secretary">
            <div class="icon-wrapper">
