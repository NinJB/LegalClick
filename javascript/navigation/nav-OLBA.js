  ...
  template: `
    <div class="layout">
      ...
      <aside class="side-nav">
        <nav>
          <a :href="'/html/OLBA-admin/lawyers.html?role_id=' + roleId" class="chosen-dashboard" data-icon="search">
          ...
          <a :href="'/html/OLBA-admin/maintenance.html?role_id=' + roleId" class="chosen-dashboard" data-icon="maintenance">
            <div class="icon-wrapper">
